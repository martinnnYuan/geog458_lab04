# GEOG 458 Lab 04 — Map Tile Generation & Web Map

## Web Map URL
- Live web map: [Page URL](https://martinnnyuan.github.io/geog458_lab04/index.html)
...
## Available Zoom Levels (Per Tileset)


- **Tileset 1**: min zoom **11** → max zoom **15**
- **Tileset 2**: min zoom **11** → max zoom **15**
- **Tileset 3**: min zoom **11** → max zoom **15**
- **Tileset 4**: min zoom **11** → max zoom **15**
